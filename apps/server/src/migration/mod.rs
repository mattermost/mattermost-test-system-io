...
mod m20260118_000002_create_report_groups;
mod m20260118_000003_create_reports;
mod m20260118_000005_create_suites;
mod m20260118_000006_create_cases;
...
mod m20260228_000013_create_oidc_claims;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20260118_000002_create_report_groups::Migration),
            Box::new(m20260118_000003_create_reports::Migration),
            Box::new(m20260118_000005_create_suites::Migration),
            Box::new(m20260118_000006_create_cases::Migration),
            ...
            Box::new(m20260228_000013_create_oidc_claims::Migration),
        ]
    }
}
