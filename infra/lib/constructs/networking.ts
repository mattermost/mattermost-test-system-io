...
export class Networking extends Construct {
  ...
  constructor(scope: Construct, id: string, props: NetworkingProps) {
    ...
    // Pinned ACM certificate. Imported by ARN rather than created
    // in-stack so a CDK version bump can't drift a property default.
    // The pre-issued cert already covers `*.{domainName}` plus every
    // per-env subdomain SAN.
